...
__.extend(ReservedIp.prototype, {
  create: function create__1(name, location, options, _) { var self, params, progress, __this = this; var __frame = { name: "create__1", line: 28 }; return __func(_, this, arguments, create__1, 3, __frame, function __$create__1() { self = __this;
      ...
      if (options.serviceName) {
        if (!options.deploymentName) {
          self.output.error($("Deployment name must be provided")); } ;

        params.serviceName = options.serviceName;
        params.deploymentName = options.deploymentName; } ;
      ...
      progress = self.interaction.progress($("Creating reserved IP address")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$create__1() {
            ...
            return self.networkManagementClient.reservedIPs.create(params, __cb(_, __frame, 22, 47, function __$create__1() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$create__1() {
  ...
  list: function list__2(options, _) { var self, progress, reservedIPs, __this = this; var __frame = { name: "list__2", line: 56 }; return __func(_, this, arguments, list__2, 1, __frame, function __$list__2() { self = __this;
          ...
          self.interaction.formatOutput(reservedIPs.reservedIPs, function(data) {
            if ((data.length === 0)) {
              ...
              self.output.table(data, function(row, ip) {
                ...
                row.cell($("Service Name"), (ip.serviceName || ""));
                row.cell($("Deployment Name"), (ip.deploymentName || ""));
  ...
  show: function show__3(name, options, _) { var self, reservedIP, __this = this; var __frame = { name: "show__3", line: 84 }; return __func(_, this, arguments, show__3, 2, __frame, function __$show__3() { self = __this;
      ...
      return self.get(name, __cb(_, __frame, 2, 26, function ___(__0, __1) { reservedIP = __1;
        ...
        if (reservedIP) {
          self.interaction.formatOutput(reservedIP, function(ip) {
            ...
            self.output.nameValue($("Service Name"), (ip.serviceName || ""));
            self.output.nameValue($("Deployment Name"), (ip.deploymentName || ""));
  ...
  delete: function delete__4(name, options, _) { var self, progress, __this = this; var __frame = { name: "delete__4", line: 107 }; return __func(_, this, arguments, delete__4, 2, __frame, function __$delete__4() { self = __this;
  ...
  get: function get__5(name, _) { var self, progress, reservedIP, __this = this; var __frame = { name: "get__5", line: 126 }; return __func(_, this, arguments, get__5, 1, __frame, function __$get__5() { self = __this;
  ...
  associate: function associate__6(name, serviceName, deploymentName, options, _) { var self, params, progress, __this = this; var __frame = { name: "associate__6", line: 142 }; return __func(_, this, arguments, associate__6, 4, __frame, function __$associate__6() { self = __this;

      params = {
        deploymentName: deploymentName,
        serviceName: serviceName };

      progress = self.interaction.progress($("Setting reserved IP address and cloud service association")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$associate__6() {

            return self.networkManagementClient.reservedIPs.associate(name, params, __cb(_, __frame, 8, 47, function __$associate__6() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$associate__6() {

              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$associate__6() { _(); }); }); }); },



  disassociate: function disassociate__7(name, serviceName, deploymentName, options, _) { var self, params, progress, __this = this; var __frame = { name: "disassociate__7", line: 156 }; return __func(_, this, arguments, disassociate__7, 4, __frame, function __$disassociate__7() { self = __this;
      ...
      progress = self.interaction.progress($("Removing reserved IP address and cloud service association")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$disassociate__7() {

            return self.networkManagementClient.reservedIPs.disassociate(name, params, __cb(_, __frame, 10, 47, function __$disassociate__7() { _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$disassociate__7() {

              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$disassociate__7() { _(); }); }); }); }});
